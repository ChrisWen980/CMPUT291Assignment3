...
"The README file should have the name(s) of student(s), their ccid(s), collaboration statement, a list of all included files, plus a .txt file with brief instructions on how to run the application. The README file should also include a section with a simple "how to” guide for executing each task."
____________________________________________________________________
